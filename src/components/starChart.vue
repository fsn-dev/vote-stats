  ...
  <div class="container">
    <h1>投票展示</h1>
		...
		<div class="tip_box">
			<h4>方案说明：</h4>
			<dl class="text-l">
				<dt>解决方案1:<small>(投票地址：0x1111111111111111111111111111111111111111)</small></dt>
				<dd>主网不分叉，数据不回滚，保持现状。<br>影响范围：被盗账户剩余资金仍然会转移或抛售。</dd>
				<dt>解决方案2:<small>(投票地址：0x2222222222222222222222222222222222222222)</small></dt>
...
影响范围：被盗账户清零，基金会账户拿回剩余部分被盗资金。 在主网区块高度600000之后，盗账户剩余资金通过DEX、OTC、SWAP、TimeLock等任何类型交易卖出都会被回滚，用户购买的盗币会被清零。</dd>
				<dt>解决方案3:<small>(投票地址：0x3333333333333333333333333333333333333333)</small></dt>
				<dd>主网不分叉，数据不回滚，保持现状。<br>影响范围：被盗账户剩余资金仍然会转移或抛售。</dd>
			</dl>
		</div>
  </div>
